    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-neutral-800 rounded-lg shadow-lg z-10">
          <div className="p-3">
            <h3 className="font-medium text-sm mb-2 text-white/60">
              Select Unit System
            </h3>
            <div className="flex gap-2 mb-2">
              <button
                className={`flex-1 py-2 px-3 rounded ${
                  unitSettings.system === UNIT_SYSTEMS.METRIC
                    ? "bg-blue-700"
                    : "bg-neutral-700"
                }`}
              ...
              <button
                className={`flex-1 py-2 px-3 rounded ${
                  unitSettings.system === UNIT_SYSTEMS.IMPERIAL
                    ? "bg-blue-700"
                    : "bg-neutral-700"
                }`}
            ...
            <div className="mt-4">
                ...
                <div className="flex gap-2">
                  <button
                    className={`flex-1 py-1 px-2 text-sm rounded ${
                      unitSettings.temperature === UNITS.TEMPERATURE.CELSIUS
                        ? "bg-blue-700"
                        : "bg-neutral-700"
                    }`}
                    onClick={() =>
                      handleUnitSelect("temperature", UNITS.TEMPERATURE.CELSIUS)
                    }
                  >
                    Celsius (°C)
                  </button>
                  <button
                    className={`flex-1 py-1 px-2 text-sm rounded ${
                      unitSettings.temperature === UNITS.TEMPERATURE.FAHRENHEIT
                        ? "bg-blue-700"
                        : "bg-neutral-700"
                    }`}
                    onClick={() =>
              ...
              <div className="mb-3">
                ...
                <div className="flex gap-2">
                  <button
                    className={`flex-1 py-1 px-2 text-sm rounded ${
                      unitSettings.windSpeed === UNITS.WIND_SPEED.KMH
                        ? "bg-blue-700"
                        : "bg-neutral-700"
                    }`}
                    onClick={() =>
                      handleUnitSelect("windSpeed", UNITS.WIND_SPEED.KMH)
                    }
                  >
                    km/h
                  </button>
                  <button
                    className={`flex-1 py-1 px-2 text-sm rounded ${
                      unitSettings.windSpeed === UNITS.WIND_SPEED.MPH
                        ? "bg-blue-700"
                        : "bg-neutral-700"
                    }`}
                    onClick={() =>
                      handleUnitSelect("windSpeed", UNITS.WIND_SPEED.MPH)
                    }
                  >
                    mph
                  </button>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <button
                    className={`flex-1 py-1 px-2 text-sm rounded ${
                      unitSettings.precipitation === UNITS.PRECIPITATION.MM
                        ? "bg-blue-700"
                        : "bg-neutral-700"
                    }`}
                    onClick={() =>
                      handleUnitSelect("precipitation", UNITS.PRECIPITATION.MM)
                    }
                  >
                    Millimeters (mm)
                  </button>
                  <button
                    className={`flex-1 py-1 px-2 text-sm rounded ${
                      unitSettings.precipitation === UNITS.PRECIPITATION.INCHES
                        ? "bg-blue-700"
                        : "bg-neutral-700"
                    }`}
                    onClick={() =>
